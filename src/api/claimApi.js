...
export const claimApi = {
  ...
  submitWithDocuments: (formData) =>
    api.post("/claims/with-documents", formData, {
  ...
  assign: (claimId, agentId) =>
    api.patch(`/claims/${claimId}/assign/${agentId}`),
  ...
  getHistory: (claimId, params) =>
    api.get(`/claims/${claimId}/history`, { params }),
};
